...
NP=" ../../node/source"
NODE_OBJ="$NP/global.o $NP/node.o $NP/monitor-processes.o $NP/node-core.o $NP/add-on-node-mapper.o"
NODE_OBJ+="$NP/ping-node-mapper.o $NP/communication.o $NP/delete-node.o $NP/check-node-exists.o"
NODE_OBJ+="$NP/node-server.o $NP/node-client.o $NP/create-node-connection.o $NP/node-global.o"
NODE_OBJ+="$NP/generate-connection-id.o $NP/node-server-ping.o $NP/delete-connection.o"
...
NODE_MAPPER_OBJ="$NNP/global.o $NNP/node-mapper.o $NNP/node-control.o $NNP/communication.o"
NODE_MAPPER_OBJ+="$NNP/add-node.o $NNP/create-node.o $NNP/delete-node.o $NNP/generate-node-id.o"
NODE_MAPPER_OBJ+="$NNP/get-nodes.o $NNP/ping-node.o $NNP/check-node-exists.o $NNP/create-node-connection.o"
NODE_MAPPER_OBJ+="$NNP/connection-manager.o $NNP/connection-control.o $NNP/timeout-control.o $NNP/delete-connection.o"
...
rm -rf verbum
gcc -o verbum verbum.c $HEADER $LIBRARY_OBJS $UTILS_OBJ $NODE_OBJ $NODE_MAPPER_OBJ $LIBRARIES 
