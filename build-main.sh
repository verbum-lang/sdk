...
rm -rf ../build/verbum
rm -rf verbum.o loader.o help.o lexer.o
...
echo "Compile: lexer.cc"
$COMPILER_PATH -c lexer.cc -I../dependencies/ANTLR4/runtime/src -I./parser -Wno-overloaded-virtual
...
$COMPILER_PATH -Wall -pedantic -W -O3 -DNDEBUG -O3 -DNDEBUG -rdynamic verbum.o ./parser/TLexer.o \
    ...
    ./help.o ./loader.o ./lexer.o -o ../build/verbum ../dependencies/ANTLR4/dist/libantlr4-runtime.a -luuid 
